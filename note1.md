...
|------|-------------|--------|------------|
| Akurasi <70% | 30% | High | - Tambah data training<br>- Ensemble model<br>- Konsultasi meteorolog |
| LLM halusinasi >30% | 20% | Critical | - Fallback ke template<br>- Fact-checking layer<br>- Fine-tune lokal |
| Sensor failure | 40% | Medium | - Redundant sensor<br>- Fallback ke BMKG |
| Biaya API tinggi | 30% | Medium | - Switch ke LLaMA-3<br>- Hybrid rule+LLM |
| BPBD tidak adopt | 10% | High | - Early engagement<br>- Pilot UNMUL only |
